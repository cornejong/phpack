...
class Autoloader
{
    ...
    /**
     * Adds a collection namespace prefixes and their base directories.
     *
     * @param array $namespaces The namespace array.
     *      example: [
     *          "App\\Controllers" => "/path/to/app/controllers",
     *          "App\\Modules" => "/path/to/app/modules",
     *      ]
     * @param bool $prepend If true, prepend the base directory to the stack
     * instead of appending it; this causes it to be searched first rather
     * than last.
     * @return void
     */
    public function addNamespaces(array $namespaces, bool $prepend = false)
    {
        foreach($namespaces as $prefix => $directory) {
            $this->addNamespace($prefix, $directory, $prepend);
        } 
    }
