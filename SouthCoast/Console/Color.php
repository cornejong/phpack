...
class Color
{
     ...
     * @param bool $invert
     */
    public static function red(string $message, bool $invert = false): string
    {
     ...
     * @param bool $invert
     */
    public static function green(string $message, bool $invert = false): string
    {
     ...
     * @param bool $invert
     */
    public static function blue(string $message, bool $invert = false): string
    {
